...
module Api
  class CastMembersController < ApplicationController
    def index
      ...
      input = Application::UseCase::ListCastMemberRequest
    ...
    def create
      ...
      input = Application::UseCase::CreateCastMemberRequest.new(create_params)
      output = use_case.execute(input)
    ...
    def destroy
      ...
      input = Application::UseCase::DeleteCastMemberRequest.new(id: params[:id])
    ...
    def update
      ...
      input = Application::UseCase::UpdateCastMemberRequest.new(update_params)
      use_case.execute(input)
